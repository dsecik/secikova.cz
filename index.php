...
<body bgcolor="white" text="black" topmargin="0" leftmargin="0" rightmargin="0" cellpadding="0" cellspacing="0">
...
<table width="100%" height="350" cellpadding="0" cellspacing="0" border="0" bgcolor="092147">
	<tr>
		<td valign="center">
			<center>
...
Pro zachování grafické podoby je nutné zaslat soubor <br>v editovatelném formátu. 
		...
		<td width="450" height="250" bgcolor="">
...
<table width="450" height="" cellpadding="0" cellspacing="0" border="0">
	<tr>
		...
		<td width="120" height="50" bgcolor="0f3062">
			<center><font color="white">z němčiny do češtiny</font></center>
		</td>
		<td width="120" height="50" bgcolor="0f3062">
			<center><font color="white">z češtiny do němčiny</font></center>
		</td>
	</tr>
	<tr>
		<td width="220" height="10">
	...
	<tr bgcolor="e8e7e7">
		<td width="220" height="50">
			<center><b>expresní překlady</b><br>
				do 24 hodin
			</center>
		</td>
		<td width="120" height="50">
			<center>dle domluvy</center>
		</td>
		<td width="120" height="50">
			<center>dle domluvy</center>
		</td>
...
<table width="450" height="" cellpadding="0" cellspacing="0" border="0">
	<tr>
		...
		<td width="120" height="50" bgcolor="0f3062">
			<center><font color="white"><b>půl dne</b></br>
				(cca 4 hodiny)</font></center>
		</td>
		<td width="120" height="50" bgcolor="0f3062">
			<center><font color="white"><b>celý den</b></br>
				(cca 8 hodin)</font></center>
		</td>
	</tr>
	<tr>
		<td width="220" height="10">
...
<form action="form_success.php" method="post" class="mf">
	<table border="0">
		<tr>
			<td align="right"><font color="white">Jméno:</font></td>
			<td><input type="text" name="name" id="mf-name"></td>
		</tr>
		<tr>
			<td align="right"><font color="white">E-mail:</font></td>
			<td><input type="text" name="email" id="mf-email"></td>
		</tr>
		<tr>
			<td align="right" valign="top"><font color="white">Zpráva:</font></td>
			<td><textarea name="message" rows="4" cols="60" id="mf-message"></textarea></td>
		</tr>
		<tr>
			<td></td>
